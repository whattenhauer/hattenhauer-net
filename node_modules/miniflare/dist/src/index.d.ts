...
import { SendEmailBinding } from '@cloudflare/config';
import { ServiceDesignator as ServiceDesignator_2 } from '../..';
...
import { VpcNetworkBinding } from '@cloudflare/config';
import { z } from 'zod';
...
export declare function buildObjectEntryProps(id: string): Record<string, unknown>;
...
export declare type ContainerPrivileges = Worker_DurableObjectNamespace_ContainerOptions_ContainerPrivileges | undefined;

/** Caches privilege detection for the current container engine. */
export declare class ContainerPrivilegesCache {
    #private;
    ...
    get(containerEngine: Worker_ContainerEngine): Promise<ContainerPrivileges>;
}
...
export declare const CoreBindings: {
    ...
    readonly DEV_REGISTRY_INSTANCE_ID: "DEV_REGISTRY_INSTANCE_ID";
    readonly SERVICE_STREAM: "MINIFLARE_STREAM";
    readonly SERVICE_IMAGES_DELIVERY: "MINIFLARE_IMAGES_DELIVERY";
    readonly SERVICE_D1: "MINIFLARE_D1";
    readonly SERVICE_KV: "MINIFLARE_KV";
    readonly SERVICE_R2: "MINIFLARE_R2";
    ...
    readonly JSON_ACCESS_BLOB_PREFIX: "MINIFLARE_ACCESS_BLOB_";
    readonly TEXT_FALLBACK_WORKER_NAME: "MINIFLARE_FALLBACK_WORKER_NAME";
    readonly SERVICE_EMAIL_STORE: "MINIFLARE_EMAIL_STORE";
    readonly SERVICE_EXPLORER_USER_WORKER_PREFIX: "MINIFLARE_EXPLORER_USER_WORKER_";
};
...
export declare const CoreHeaders: {
    ...
    readonly ACCESS_BLOB: "MF-Access-Blob";
...
export declare const CorePaths: {
    ...
    readonly IMAGE_UPLOAD: "/__cf_local/imageupload";
...
export declare const DevConfigSchema: z.ZodObject<{
    ...
    access: z.ZodOptional<z.ZodObject<{
        aud: z.ZodString;
        identity: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodUnknown>>;
    }, z.core.$strict>>;
}, z.core.$strict>;
...
export declare type EmailHandlerEvent = {
...
export declare interface EmailHandlerForward {
    messageId: string;
    recipient: string;
    headers: [string, string][];
}

export declare interface EmailHandlerReply {
    messageId: string;
    sender: string;
    raw: string;
    rawBase64?: string;
...
export declare interface EmailHandlerResult {
 ...
 */
export declare function getConnectSocketName(workerIndex: number, protocol: "tcp" | "udp", port: number): string;
...
export declare function getImagesBindingServiceName(name: string): string;
...
export declare function getR2PublicService(allWorkerOpts: ParsedWorkerOptions[], sharedOptions: Pick<ParsedInstanceOptions, "resourcePersistencePath" | "unsafeEnableSharedStorage">): Service_2 | undefined;

export declare function getR2S3Service(allWorkerOpts: ParsedWorkerOptions[], sharedOptions: Pick<ParsedInstanceOptions, "resourcePersistencePath" | "unsafeEnableSharedStorage">): Service_2 | undefined;
...
export declare function getStorageScope(resourcePersistencePath: string | undefined): string | undefined;

export declare function getStorageService(localServiceName: string, props: Record<string, unknown>, sharedOptions: Pick<ParsedInstanceOptions, "resourcePersistencePath" | "unsafeEnableSharedStorage">, options?: {
    entrypoint?: string;
    rpcProperties?: string[];
}): ServiceDesignator;

export declare function getStreamService(sharedOptions: Pick<ParsedInstanceOptions, "resourcePersistencePath" | "unsafeEnableSharedStorage">): ServiceDesignator_2;
...
export declare const InstanceOptionsSchema: z.ZodObject<{
    ...
    isolatedResourcePersistencePath: z.ZodOptional<z.ZodString>;
    resourceTmpPath: z.ZodOptional<z.ZodString>;
    unsafeEnableSharedStorage: z.ZodOptional<z.ZodBoolean>;
...
export declare const KV_LOCAL_ENTRY_SERVICE_NAME = "kv:ns:entry";
...
export declare const MiniflareOptionsSchema: z.ZodPipe<z.ZodObject<{
    host: z.ZodOptional<z.ZodString>;
    port: z.ZodOptional<z.ZodNumber>;
    https: z.ZodOptional<z.ZodBoolean>;
    httpsKey: z.ZodOptional<z.ZodString>;
    ...
    workers: z.ZodArray<z.ZodObject<{
        config: z.ZodPipe<z.ZodObject<{
            ...
            observability: z.ZodOptional<z.ZodObject<{
                ...
                redactQueryString: z.ZodOptional<z.ZodBoolean>;
            ...
            env: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodType<{
                ...
                type: "worker";
                worker: string | typeof kCurrentWorker;
            ...
            manifest?: {
                ...
                modules: Record<string, {
                    type: "text" | "json" | "sourcemap" | "data" | "esm" | "cjs" | "python" | "python-requirement" | "wasm";
    ...
    workers: {
        ...
        dev: {
            ...
            useModuleFallbackService?: boolean | undefined;
    ...
    log?: Log | undefined;
    handleStructuredLogs?: ((log: WorkerdStructuredLog) => void) | undefined;
    handleUncaughtError?: ((error: Error) => void) | undefined;
    ...
    unsafeHandleDevRegistryUpdate?: ((registry: WorkerRegistry) => void) | undefined;
    unsafeHandleRuntimeRestart?: (() => Awaitable<void>) | undefined;
    unsafeProxySharedSecret?: string | undefined;
    unsafeModuleFallbackService?: ((request: Request_2, miniflare: Miniflare) => Awaitable<Response_2>) | undefined;
    ...
    unsafeObservability?: boolean | undefined;
    unsafeInspectDurableObjects?: boolean | undefined;
}, {
    logRequests: boolean;
    stripDisablePrettyError: boolean;
    telemetry: {
...
export declare const ParsedMiniflareKnownBindingSchema: z.ZodDiscriminatedUnion<[z.ZodObject<{
    ...
    dev: z.ZodOptional<z.ZodObject<{
        remote: z.ZodOptional<z.ZodBoolean>;
        experimentalS3Credentials: z.ZodOptional<z.ZodObject<{
    ...
    worker: z.ZodUnion<readonly [z.ZodString, z.ZodCustom<typeof kCurrentWorker, typeof kCurrentWorker>]>;
}, z.core.$strict> | z.ZodObject<{
    type: z.ZodLiteral<"fetcher">;
    handler: z.ZodCustom<(request: Request_2, miniflare: Miniflare) => Awaitable<Response_2>, (request: Request_2, miniflare: Miniflare) => Awaitable<Response_2>>;
}, z.core.$strict> | z.ZodObject<{
...
}, z.core.$strict> & z.ZodType<SendEmailBinding, {
    type: "send-email";
    destinationAddress?: string | undefined;
    allowedDestinationAddresses?: string[] | undefined;
    allowedSenderAddresses?: string[] | undefined;
...
}, z.core.$ZodTypeInternals<SendEmailBinding, {
    type: "send-email";
    destinationAddress?: string | undefined;
    allowedDestinationAddresses?: string[] | undefined;
    allowedSenderAddresses?: string[] | undefined;
...
}, z.core.$strict> & z.ZodType<VpcNetworkBinding, {
    type: "vpc-network";
    tunnelId?: string | undefined;
    networkId?: string | undefined;
    dev?: {
...
}, z.core.$ZodTypeInternals<VpcNetworkBinding, {
    type: "vpc-network";
    tunnelId?: string | undefined;
    networkId?: string | undefined;
    dev?: {
...
export declare interface Plugin {
    ...
    getBindings(options: ParsedWorkerOptions, sharedOptions: ParsedInstanceOptions, workerIndex: number): Awaitable<Worker_Binding[] | void>;
...
export declare const SharedHeaders: {
    ...
    readonly NAMESPACE: "MF-Namespace";
};
...
export declare interface Socket_Tcp {
    tlsOptions?: TlsOptions_2;
}
...
export declare const V4MiniflareOptionsSchema: z.ZodIntersection<z.ZodObject<{
    ...
    workers: z.ZodArray<z.ZodIntersection<z.ZodUnion<readonly [z.ZodObject<{
        ...
        connectHandlers: z.ZodOptional<z.ZodArray<z.ZodObject<{
            protocol: z.ZodEnum<{
                tcp: "tcp";
            }>;
            port: z.ZodNumber;
...
export declare interface Worker_DurableObjectNamespace_ContainerOptions {
    imageName?: string;
...
export declare interface Worker_DurableObjectNamespace_ContainerOptions_ContainerPrivileges_Device {
    pathOnHost?: string;
